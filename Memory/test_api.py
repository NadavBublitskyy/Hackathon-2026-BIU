...
def test_memory_index_empty_path() -> None:
    client = create_test_client()
...
def test_memory_index_invalid_path() -> None:
    client = create_test_client()
...
def test_memory_retrieve_success() -> None:
    client = create_test_client()
...
def test_memory_retrieve_empty_query() -> None:
    client = create_test_client()
...
def test_memory_retrieve_unrelated_query() -> None:
    client = create_test_client()
...
def run_tests() -> None:
    test_memory_index_success()
    test_memory_index_empty_path()
    test_memory_index_invalid_path()
    test_memory_retrieve_success()
    test_memory_retrieve_empty_query()
    test_memory_retrieve_unrelated_query()
